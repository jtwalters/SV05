...
#define STRING_CONFIG_H_AUTHOR "(Mike Hill, Sovol SV05)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SV05"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  37.85
    #define DEFAULT_Ki   4.73
    #define DEFAULT_Kd  75.69
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 182.53
  #define DEFAULT_bedKi 35.65
  #define DEFAULT_bedKd 623.04
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.0013  // (mm) Distance from real junction edge
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 40, 5, -2.06 }
